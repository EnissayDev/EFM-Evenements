    ...
    <div class="container">
        ...
        <form action="${pageContext.request.contextPath}/catalogue" method="GET" class="search-bar-container">
            ...
            <div class="search-input form-group" style="margin-bottom: 0;">
                <input type="text" name="keyword" class="live-search" placeholder="Rechercher par nom (ex: Concert, Conférence...)" value="${param.keyword}">
            </div>

            <div class="search-select form-group" style="margin-bottom: 0;">
                <select name="category" onchange="this.form.submit()" style="width: 100%; padding: 12px; border: 1px solid #c8c6c4; border-radius: 4px; font-size: 16px;">
